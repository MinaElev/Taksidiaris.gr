...
description: "Ένα από τα πιο θρυλικά μοναστήρια του Αιγαίου, κρεμασμένο σε γκρεμό πάνω στη θάλασσα. Φυλάει καρφί από τον Σταυρό του Χριστού. Ιστορία, ωράρια, πρόσβαση."
destination: ellada/thasos
type: monument
tagline: "Στον γκρεμό πάνω από τη θάλασσα, το μοναστήρι φυλάει καρφί από τον Σταυρό της Σταύρωσης που η παράδοση λέει ότι κανείς δεν κατάφερε ποτέ να πάρει από εδώ."
intro: >-
  Η Μονή Αρχαγγέλου Μιχαήλ βρίσκεται κρεμασμένη πάνω σε έναν απόκρημνο βράχο
  στη νοτιοανατολική ακτή της Θάσου, με τη θάλασσα να φαίνεται κυριολεκτικά
  100 μέτρα κάτω από τα κελιά. Ιδρύθηκε γύρω στο 1110 μ.Χ. από τον ερημίτη
  Λουκά που κατά την παράδοση έχτισε εδώ ένα μικρό εκκλησάκι μετά από όραμα
  του Αρχαγγέλου Μιχαήλ. Η μονή είναι εξαρτημένη από τη Μονή Φιλοθέου του
  Αγίου Όρους, και από το 1974 επανακατοικείται από μοναχές. Φυλάει ένα από
  τα πιο ιερά λείψανα του Ορθόδοξου κόσμου: ένα από τα καρφιά της Σταύρωσης
  του Χριστού. Η θέση, η θέα και η ιστορία το κάνουν μία από τις πιο
  συναρπαστικές στάσεις στο νησί, ανεξάρτητα αν είσαι θρησκευόμενος ή όχι.
faqs:
  - q: Πού βρίσκεται το μοναστήρι και πώς φτάνω;
    a: "Στη νοτιοανατολική Θάσο, περίπου 4 χλμ μετά την Αλυκή προς τον νότο. Ο δρόμος είναι άσφαλτος όλος. Από Λιμένα: 40 λεπτά. Υπάρχει πινακίδα στον κεντρικό περιφερειακό δρόμο που στρίβει προς τα πάνω και καταλήγει σε parking στην είσοδο. Είναι πρακτικά αδύνατο να το βρεις χωρίς αυτοκίνητο — δεν υπάρχει ΚΤΕΛ εκεί."
  - q: Πληρώνω είσοδο και ποιες ώρες είναι ανοιχτό;
    a: "Η είσοδος είναι δωρεάν, αλλά γίνονται δεκτές προαιρετικές εισφορές για τη συντήρηση. Ωράριο το καλοκαίρι: 9:00-18:00 με διάλειμμα 12:00-15:00. Τον χειμώνα 10:00-16:00. Κλειστό κατά τη διάρκεια της Μεγάλης Σαρακοστής για επισκέπτες εκτός λειτουργίας."
  - q: Χρειάζομαι κάποιον κώδικα ένδυσης;
    a: "Ναι, όπως σε όλα τα μοναστήρια. Οι γυναίκες πρέπει να φοράνε μακρύ φόρεμα ή φούστα (κάτω από το γόνατο) και καλυμμένους ώμους. Οι άντρες μακρύ παντελόνι (όχι σορτς) και μανίκια. Στην είσοδο υπάρχουν πανωφόρια-φούστες διαθέσιμες δωρεάν αν έχεις πάει με καλοκαιρινά ρούχα."
  - q: Ποια είναι η ιστορία του Τιμίου Καρφιού;
    a: "Η παράδοση λέει ότι τον 4ο αιώνα η αγία Ελένη, μητέρα του Μεγάλου Κωνσταντίνου, βρήκε τον Τίμιο Σταυρό στα Ιεροσόλυμα και τα τρία καρφιά μαζί του. Ένα από αυτά δόθηκε στη Μονή Φιλοθέου του Αγίου Όρους. Όταν οι Τούρκοι αύξησαν τους φόρους στα μοναστήρια, μοναχοί πήραν το καρφί και άλλα κειμήλια για να φύγουν. Σε θύελλα κατέφυγαν στη Θάσο, στο εκκλησάκι όπου σήμερα είναι η μονή. Πειρατές τους σκότωσαν, αλλά πρόλαβαν να κρύψουν τα κειμήλια στο τοίχωμα. Αργότερα βρέθηκαν, και ο Αρχάγγελος Μιχαήλ — σύμφωνα με την παράδοση — μέσω οραμάτων επέβαλε το καρφί να μείνει εδώ, στη Θάσο."
  - q: Μπορώ να δω το Τίμιο Καρφί;
    a: "Ναι. Το καρφί εκτίθεται σε ειδική θήκη και μπορείς να το προσκυνήσεις κατά τις ώρες επισκεψημότητας. Είναι από τα πιο σημαντικά χριστιανικά λείψανα της Ελλάδας και ελκύει προσκυνητές από όλη την Ορθόδοξη Ευρώπη."
  - q: Πότε είναι η γιορτή του Αρχαγγέλου;
    a: "Η γιορτή του Αρχαγγέλου Μιχαήλ είναι στις 8 Νοεμβρίου, αλλά στη Θάσο το μοναστήρι γιορτάζει με ξεχωριστή κύρια τελετή την Τρίτη της Διακαινησίμου (δηλαδή Τρίτη μετά το Πάσχα), που συνδέεται με την επιστροφή του Τιμίου Καρφιού. Εκείνη τη μέρα το μοναστήρι γεμίζει προσκυνητές και γίνεται μεγάλη πανηγυρική λειτουργία."
keywords:
...
sources:
  - title: Monastiria.gr — Μονή Αρχαγγέλου Μιχαήλ Θάσου
    url: https://www.monastiria.gr/holy-monastery-of-archangel-michael-thasos-island/?lang=en
  - title: Nikana.gr — Monastery of Saint Archangel Michael
    url: https://nikana.gr/en/tourist-guide/thassos/what-to-see/1605/monastery-of-saint-archangel-michael-and-the-holy-nail
  - title: Greeka — Monastery of Archangel Thassos
    url: https://www.greeka.com/eastern-aegean/thassos/sightseeing/thassos-monastery-archangel/
