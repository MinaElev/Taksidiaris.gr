...
description: Ένας μικρός αμφιθεατρικός οικισμός σε ύψος 16 μέτρων, χτισμένος σε γραφικό όρμο με καθαρά βαθιά νερά. Το όνομά του, οι ταβέρνες του, η πιο ήσυχη πλευρά της Αλοννήσου.
destination: ellada/alonnisos
type: village
hero: /images/destinations/alonnisos/votsi.jpg
tagline: Το πιο χαλαρό ψαροχώρι του νησιού, με όνομα που έρχεται από τον Α΄ Βαλκανικό Πόλεμο.
intro: >-
  ...
  χτισμένος μόλις 16 μέτρα πάνω από τη στάθμη της θάλασσας, σε έναν από τους
  πιο γραφικούς όρμους της Αλοννήσου. Είναι μία από τις πιο ήσυχες ταυτόχρονα
  πιο πραγματικές γειτονιές του νησιού — ψαράδες βγάζουν βάρκες, οικογένειες
  τρώνε φρέσκο ψάρι, παιδιά βουτάνε από την προβλήτα.
faqs:
  - q: Πώς φτάνω στη Βότση;
    a: Είναι 3 χλμ. βόρεια από το Πατητήρι — 5 λεπτά με αυτοκίνητο ή μηχανάκι, 15 λεπτά περπάτημα. Υπάρχει επίσης τακτικό λεωφορείο που κάνει τη διαδρομή Πατητήρι → Βότση → Χρυσή Μηλιά → Κοκκινόκαστρο, με αναχωρήσεις περίπου ανά ώρα το καλοκαίρι.
  - q: Που οφείλεται το όνομα;
    a: Στον Υδραίο υποναύαρχο Νικόλαο Βότση. Ο Βότσης πέρασε από την Αλόννησο το 1913, μετά τις διακριτικές πράξεις του στον Α΄ Βαλκανικό Πόλεμο (1912–1913), και επισκέφτηκε τη συγκεκριμένη περιοχή του σημερινού οικισμού. Ο οικισμός πήρε σταδιακά το όνομά του προς τιμήν του.
  - q: Έχει παραλία η Βότση;
    a: Ναι, μια μικρή παραλία δίπλα στο λιμανάκι με άμμο ανακατεμένη με βότσαλα, βαθιά γαλαζοπράσινα νερά, και σκιά από πεύκα. Καλύτερη για μπάνιο σε ενήλικες παρά για οικογένειες με μικρά παιδιά. Για αμμουδιά ιδανική για παιδιά, πηγαίνεις στη Χρυσή Μηλιά ένα χιλιόμετρο βορειότερα.
  - q: Ταβέρνες και εστιατόρια;
    a: "Ναι, τρεις-τέσσερις ταβέρνες δίπλα στο λιμανάκι που σερβίρουν κυρίως φρέσκο ψάρι και θαλασσινά, πολλά από αυτά ψαρεμένα από τα ίδια βάρκες των ντόπιων. Ο αλοννησιώτικος τόνος είναι η τοπική σπεσιαλιτέ. Τιμές μετρίες: 20–30 € το άτομο για ένα καλό γεύμα με ψάρι."
keywords:
  - βότση
  - βοτσή αλόννησος
  - παραλία βότση
