...
description: >-
  Ένα έρημο νησί με έναν από τους σημαντικότερους προϊστορικούς χώρους της
  Ελλάδας. Νεολιθικά ευρήματα 9.000 ετών, η Capra aegagrus που μοιάζει με τα
  κρι-κρι της Κρήτης, και το σπήλαιο που συνδέθηκε στην παράδοση με τον
  Πολύφημο.
destination: ellada/alonnisos
type: island
hero: >-
  https://kzafwpcltanwjyyqdqbj.supabase.co/storage/v1/object/public/uploads/places-ellada-alonnisos/cave-skopelos0701-b-mocsb9ln.jpg
intro: >-
  ...
  κατσίκας — Capra aegagrus — στενός συγγενής του κρι-κρι της Κρήτης. Μέσα του
  υπάρχει ένα σπήλαιο που η ανασκαφή έχει δείξει ότι κατοικήθηκε συνεχώς από τη
  Μεσολιθική περίοδο μέχρι τη Νεολιθική, δηλαδή για πάνω από τέσσερις χιλιάδες
  χρόνια. Και στην τοπική παράδοση, αυτό το σπήλαιο είναι «το σπήλαιο του
  Κύκλωπα» — όπου, σύμφωνα με μία εκδοχή, ο Οδυσσέας συνάντησε τον Πολύφημο.
tagline: >-
  Ο Οδυσσέας πέρασε κι από εδώ — τουλάχιστον σύμφωνα με την παράδοση. Οι
  αρχαιολόγοι λένε κάτι πιο εντυπωσιακό: κάποιος πέρασε πριν από 9.000 χρόνια.
faqs:
  - q: Μπορώ να κατέβω στη Γυούρα και να δω το σπήλαιο;
    a: >-
      Όχι ελεύθερα. Η Γυούρα βρίσκεται σε Ζώνη Α2 του πάρκου και το σπήλαιο του
      Κύκλωπα είναι προστατευμένος αρχαιολογικός χώρος — χρειάζεται ειδική άδεια
      από την αρχαιολογική υπηρεσία. Τα τουριστικά σκάφη περνούν κοντά,
      αγκυροβολούν σε συγκεκριμένους όρμους, αλλά η είσοδος στο σπήλαιο δεν
      είναι επιτρεπτή στο κοινό.
  - q: Τότε γιατί να συμπεριλάβω τη Γυούρα στη βαρκάδα μου;
    a: >-
      Για τρεις λόγους. Πρώτον, η θέα των ακτογραμμών: απόκρημνα λευκά βράχια
      που κατεβαίνουν κάθετα στη θάλασσα, σπάνιο θέαμα. Δεύτερον, οι πιθανότητες
      να δεις άγρια κατσίκα στα βουνά του νησιού από σκάφος είναι πραγματικές.
      Τρίτον, είναι από τα σπάνια σημεία όπου μπορεί να δεις Μεσογειακή Φώκια
      χωρίς να παραβιάσεις τον κανονισμό.
  - q: Τι ανακάλυψαν οι αρχαιολόγοι στο σπήλαιο;
    a: >-
      Λίθινα εργαλεία Μεσολιθικής περιόδου (9.000–7.000 π.Χ.), νεολιθική
      κεραμική περίτεχνα διακοσμημένη (Μέση Νεολιθική, περίπου 5.500 π.Χ.),
      πολλά οστά ζώων που δείχνουν εκτεταμένη κτηνοτροφία, και θραύσματα οστρέων
      που αποδεικνύουν διατροφική χρήση της θάλασσας. Επικεφαλής της ανασκαφής
      ήταν ο καθηγητής Αδαμάντιος Σάμψων, που έδωσε και το πληρέστερο σχετικό
      δημοσίευμα.
  - q: Η άγρια κατσίκα της Γυούρας είναι η ίδια με το κρι-κρι;
    a: >-
      Είναι του ίδιου είδους (Capra aegagrus), αλλά οι πληθυσμοί είναι γενετικά
      διαφορετικοί και εξελίσσονται απομονωμένα εδώ και χιλιάδες χρόνια. Οι
      ειδικοί συζητούν αν πρόκειται για ξεχωριστή υποσπεκία. Αυτό που μετράει
      τουριστικά: είναι από τους τελευταίους πραγματικά άγριους πληθυσμούς
      τέτοιου είδους στην Ευρώπη.
keywords:
  - γυούρα
  - σπήλαιο κύκλωπα
  - νεολιθική αιγαίο
...
sources:
  ...
  - title: Βικιπαίδεια — Σπηλιά του Κύκλωπα
    url: >-
      https://el.wikipedia.org/wiki/%CE%A3%CF%80%CE%B7%CE%BB%CE%B9%CE%AC_%CF%84%CE%BF%CF%85_%CE%9A%CF%8D%CE%BA%CE%BB%CF%89%CF%80%CE%B1
  - title: Βικιπαίδεια — Γυούρα Αλοννήσου
    url: >-
      https://el.wikipedia.org/wiki/%CE%93%CE%B9%CE%BF%CF%8D%CF%81%CE%B1_%CE%91%CE%BB%CE%BF%CE%BD%CE%BD%CE%AE%CF%83%CE%BF%CF%85
relatedPlaces:
